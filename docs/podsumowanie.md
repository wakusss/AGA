...
- Usuwanie i edytowanie własnego posta (z weryfikacją autora)
- Wyszukanie konkretnego postu za pomocą linku (share)
...
2. Zrealizowane tworzenie, polubienie, komentowanie, udostępnianie postów
